...
def main():
    ...
    if choice == "Home":
          ...
          if st.button("Tiempo de Venta y/o Arriendo"):
            ...
            plantilla=pd.read_excel("/Users/dsgiraldo/Desktop/PLANTILLAVENTAS.xlsx")
   ...
   # IMPORTANT: Cache the conversion to prevent computation on every rerun
           ...
           plantilla2=pd.read_excel("/Users/dsgiraldo/Desktop/PLANTILLAARRIENDO.xlsx")
